  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'sm': ['0.9375rem', { lineHeight: '1.6', letterSpacing: '0.005em' }],
        'base': ['1.0625rem', { lineHeight: '1.75', letterSpacing: '0' }],
        'lg': ['1.1875rem', { lineHeight: '1.75', letterSpacing: '-0.005em' }],
        'xl': ['1.375rem', { lineHeight: '1.6', letterSpacing: '-0.01em' }],
        '2xl': ['1.625rem', { lineHeight: '1.5', letterSpacing: '-0.015em' }],
        '3xl': ['2rem', { lineHeight: '1.4', letterSpacing: '-0.02em' }],
        '4xl': ['2.5rem', { lineHeight: '1.3', letterSpacing: '-0.025em' }],
